...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionExecutionResponse', function() {
      beforeEach(function() {
        instance = new OpenApiDefinition.TransactionExecutionResponse();
      });

      it('should create an instance of TransactionExecutionResponse', function() {
        // TODO: update the code to test TransactionExecutionResponse
        expect(instance).to.be.a(OpenApiDefinition.TransactionExecutionResponse);
      });
